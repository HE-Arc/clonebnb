...
<div class="col-lg-4 col-md-4 margin-top-75 sticky">
  ...
  <div class="boxed-widget margin-top-35">
    <div class="hosted-by-title">
      <h4><span>Publiée par</span> <a href="pages-user-profile.html">{{ $ad->user->first_name }}</a></h4>
      <a href="pages-user-profile.html" class="hosted-by-avatar"><img src="/uploads/avatars/{{ $ad->user->photo }}" alt=""></a>
    </div>
    <ul class="listing-details-sidebar">
      <li><i class="fa fa-phone"></i> {{ $ad->user->phone }}</li>
      <li><i class="fa fa-envelope-o"></i> <a href="#"><span class="__cf_email__" data-cfemail="8efae1e3ceebf6efe3fee2eba0ede1e3">[email&#160;protected]</span></a></li>
    </ul>
    ...
    <div id="small-dialog" class="zoom-anim-dialog mfp-hide">
      ...
      <div class="message-reply margin-top-0">
        <textarea cols="40" rows="3" placeholder="Votre message à Thomas"></textarea>
  ...
  <div class="listing-share margin-top-40 margin-bottom-40 no-border">
    <button class="like-button"><span class="like-icon"></span> Ajouter comme favoris</button>
    <span>159 personnes on ajoutés cette annonce comme favoris</span>

      <!-- Share Buttons -->
      <ul class="share-buttons margin-top-40 margin-bottom-0">
        <li><a class="fb-share" href="#"><i class="fa fa-facebook"></i> Partager</a></li>
        <li><a class="twitter-share" href="#"><i class="fa fa-twitter"></i> Tweeter</a></li>
        <li><a class="gplus-share" href="#"><i class="fa fa-google-plus"></i> Partager</a></li>
      </ul>
