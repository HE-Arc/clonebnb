(function($) {
    ...
    $(document).ready(function() {
        ...
        //Modification en requête AJAX pour favoris
        $('.like-icon').on('click', function(e) {
            e.preventDefault();
            var is_fav;
            if($(this).toggleClass('liked')["0"].className == "like-icon liked") {
              is_fav = true;
              console.log(is_fav);
            } else {
              //is_fav = false;
            ...
            var ad_id = e.target.parentNode.parentNode.dataset['adid'];
            //alert(ad_id);
            $.ajax({
              method: 'POST',
              url: url_favorite,
              data: {is_fav: is_fav, ad_id: ad_id, _token: token}
            })
            .done(function(){
        ...
        $('.delete').on('click', function(e) {
            e.preventDefault();
            var favid = e.target.parentNode.parentNode.dataset['favid'];
            $.ajax({
              method: 'POST',
              url: url_delete,
              data: {favid: favid, _token: token}
            })
            .done(function(){
